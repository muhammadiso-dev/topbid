...
export const uz: Record<string, string> = {
  ...
  "pay.viaCard": "Karta orqali (o'tkazish)",
  ...
  "pay.cardNote": "To'lovni tekshirish uchun izohga profil nomini yozing. Shoshilinch bo'lsa: Telegram'da @TopBidSupport.",
  "pay.transferred": "O'tkazdim",
  "charity.fundName": "Sen Yolg'iz Emassan",
  "charity.fundDesc": "O'zbekistondagi eng yirik xayriya jamg'armalaridan biri — og'ir kasal bolalar va muhtoj oilalarga yordam beradi. Har oyning boshida o'tgan oyda yig'ilgan xayriya jamg'arma rasmiy hisob raqamiga o'tkaziladi va kvitansiya Telegram kanalimizda e'lon qilinadi.",
