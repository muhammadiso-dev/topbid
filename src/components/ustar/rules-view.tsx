...
import { PRICE_TIERS, VERIFICATION_FEE, formatCompactSom } from "@/lib/ustar/constants";
    ...
    <div className="max-w-2xl mx-auto px-4 pb-16">
      ...
      <header className="mt-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs md:text-sm text-[#6b5d4d] mt-0.5">Oxirgi yangilanish: 2026-yil</p>
        </div>
      </header>
      ...
      <section className="mt-7 bg-white border border-border rounded-2xl p-5 md:p-6">
        <h2 className="font-extrabold text-[#241c14] flex items-center gap-2">
          <span className="w-6 h-6 rounded-md bg-[#d97b29] text-white text-xs font-extrabold flex items-center justify-center">
            1
          </span>
          Auksion va narx darajalari
        </h2>
        ...
        <ul className="mt-4 space-y-2.5 text-[13px] md:text-sm text-[#574634] leading-relaxed">
          <li className="flex gap-2.5">
            ...
            Reytingdagi o'rin jami reyting summasi bo'yicha shakllanadi — har bir daraja o'z
            narxida raqobat qiladi, narxlar aralashmaydi.
          </li>
          <li className="flex gap-2.5">
            <span className="text-[#d97b29] font-extrabold">•</span>
            Biror o'rinni egallash uchun shu o'rin egasidan bir qadam ko'p to'lash kerak —
            «O'rinni egallash» tugmasi summani avtomatik hisoblaydi.
          </li>
          <li className="flex gap-2.5">
            <span className="text-[#d97b29] font-extrabold">•</span>
            TOP-1 o'rin uchun qo'shimcha premium to'lanadi: markazlar — 80 000, repetitorlar —
            25 000, IT mutaxassislar — 30 000 so'm.
          </li>
          <li className="flex gap-2.5">
            <span className="text-[#d97b29] font-extrabold">•</span>
          ...
          <li className="flex gap-2.5">
            <span className="text-[#d97b29] font-extrabold">•</span>
            Bir xil kontakt havolasi bilan qayta to'lov qilinsa, yangi profil ochilmaydi — summa
            mavjud profilga qo'shiladi va o'rin yangilanadi.
          </li>
        </ul>
      </section>
      ...
      <section className="mt-4 bg-gradient-to-r from-[#fdeedd] to-[#fff9f2] border border-[#f0d5b8] rounded-2xl p-5 md:p-6">
        ...
        <ul className="mt-3.5 space-y-2.5 text-[13px] md:text-sm text-[#574634] leading-relaxed">
          <li className="flex gap-2.5">
            <span className="text-[#d97b29] font-extrabold">•</span>
            Platforma ishga tushganidan keyin birinchi 2 hafta barcha narxlarga 50% chegirma
            qo'llanadi — «erta qo'shilganlarga maxsus narx».
          </li>
          <li className="flex gap-2.5">
            <span className="text-[#d97b29] font-extrabold">•</span>
            Aksiya davrida siz kamroq to'laysiz, lekin reytingga to'liq summa yoziladi — ya'ni
            raqobatda to'liq kuch bilan qatnashasiz.
          </li>
          <li className="flex gap-2.5">
            <span className="text-[#d97b29] font-extrabold">•</span>
            Aksiya hech qanday kodsiz, avtomatik qo'llanadi va tugagach narxlar avtomatik normal
            holatga qaytadi.
          </li>
        </ul>
      </section>
      ...
      <section className="mt-4 bg-white border border-border rounded-2xl p-5 md:p-6">
        ...
        <ul className="mt-4 space-y-2.5 text-[13px] md:text-sm text-[#574634] leading-relaxed">
          <li className="flex gap-2.5">
            <span className="text-[#d97b29] font-extrabold">•</span>
            Barcha to'lovlar Telegram to'lov boti orqali qabul qilinadi (karta, Payme, Click).
          </li>
          <li className="flex gap-2.5">
            <span className="text-[#d97b29] font-extrabold">•</span>
          ...
          <li className="flex gap-2.5">
            <span className="text-[#d97b29] font-extrabold">•</span>
            Qoidabuzar profil admin tomonidan o'chirilganda, barcha to'lovlar to'liq qaytariladi.
          </li>
          <li className="flex gap-2.5">
            <span className="text-[#d97b29] font-extrabold">•</span>
            Xohishingiz bilan profilingizni o'chirishingiz mumkin — unda to'lovlar qaytariladi.
          </li>
        </ul>
      </section>
      ...
      <section className="mt-4 bg-white border border-border rounded-2xl p-5 md:p-6">
        ...
        <ul className="mt-4 space-y-2.5 text-[13px] md:text-sm text-[#574634] leading-relaxed">
          ...
          <li className="flex gap-2.5">
            <span className="text-[#d97b29] font-extrabold">•</span>
            Sharh reytingdagi o'ringa ta'sir qilmaydi — u faqat boshqa foydalanuvchilar uchun
            qo'shimcha ma'lumot.
          </li>
        </ul>
      </section>
      ...
      <section className="mt-4 bg-white border border-border rounded-2xl p-5 md:p-6">
        <h2 className="font-extrabold text-[#241c14] flex items-center gap-2">
          ...
          «Tekshirilgan» belgisi (verifikatsiya)
        </h2>
        <ul className="mt-4 space-y-2.5 text-[13px] md:text-sm text-[#574634] leading-relaxed">
          <li className="flex gap-2.5">
            <span className="text-[#d97b29] font-extrabold">•</span>
            Verifikatsiya pullik xizmat: bir martalik {formatCompactSom(VERIFICATION_FEE)} to'lov
            (aksiya davrida 50% arzon).
          </li>
          <li className="flex gap-2.5">
            <span className="text-[#d97b29] font-extrabold">•</span>
            To'lovdan so'ng admin siz bilan Telegram orqali bog'lanib, diplom/litsenziya nusxasini
            so'raydi.
          </li>
          <li className="flex gap-2.5">
            <span className="text-[#d97b29] font-extrabold">•</span>
            Hujjatlar 24 soat ichida ko'rib chiqiladi: tasdiqlansa — ko'k belgi, rad etilsa —
            to'lov to'liq qaytariladi.
          </li>
          <li className="flex gap-2.5">
            <span className="text-[#d97b29] font-extrabold">•</span>
            Belgi bir marta beriladi va profil o'chirilmaguncha amal qiladi.
          </li>
        </ul>
      </section>
      ...
      <section className="mt-4 bg-[#fff9f2] border border-[#f0d5b8] rounded-2xl p-5 md:p-6">
        ...
        <p className="mt-2.5 text-[13px] md:text-sm text-[#574634] leading-relaxed">
          Har bir yangi profil, to'lov va verifikatsiya so'rovi haqida admin Telegram guruhiga
          avtomatik xabar oladi. Shubhali yoki qoidabuzar profil bir tugma bilan o'chiriladi,
          to'lov esa egasiga qaytariladi. Qoidalarga rioya qilmagan profilingiz ogohlantirishsiz
