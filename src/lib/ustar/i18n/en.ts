...
export const en: Record<string, string> = {
  ...
  // Verify modal
  "verify.subtitle": "Get the gold badge and boost trust",
  ...
  "charity.desc": "A charity foundation helping children battling cancer. At the beginning of each month, collected funds are transferred to the foundation's official account, with a receipt published in our Telegram channel.",
  ...
  "charity.fundDesc": "A charity foundation helping children battling cancer. At the beginning of each month, collected funds are transferred to the foundation's official account, with a receipt published in our Telegram channel.",
  ...
  "pay.awaitingTitle": "Awaiting payment",
  "pay.awaitingDesc": "Your profile is created! Transfer to the card — once the money arrives, it automatically appears in the rating (usually 1-2 minutes). Nothing else to do.",
  "pay.awaitingBadge": "awaiting payment",
  "pay.awaitingNote": "Note: after «I've transferred», the profile appears only when the money actually arrives on the card.",
  "verify.awaitingTitle": "Awaiting payment",
  "verify.awaitingDesc": "Transfer to the card — once the money arrives, verification starts automatically and the admin will request documents.",
  "card.awaiting": "Awaiting payment",
  "card.pending": "Awaiting documents",
  "topup.title": "Improve your spot",
  "topup.desc": "Choose a new spot — it updates automatically once the money arrives",
